...
class DashboardPage(ctk.CTkFrame):
    ...
    def _build_stats(self):
        ...
        stats = [
            (entries_counter, "Kata this week"),
        ...
        ctk.CTkLabel(
            today_card, text="Kata done today",
    ...
    def _build_streak(self):
        ...
        for i, (did, label) in enumerate(zip(streak, day_labels)):
            ...
            ctk.CTkLabel(col, text=label, font=ctk.CTkFont(size=10), text_color="gray50").pack(pady=(4, 0))

            actual_date = date.today() + timedelta(days=i - 6)
            ctk.CTkLabel(
                col, text=actual_date.strftime("%d %b"),
    ...
    def _build_recent(self):
        ...
        if not entries:
            ctk.CTkLabel(
                recent_container, text="No kata logged yet.",
